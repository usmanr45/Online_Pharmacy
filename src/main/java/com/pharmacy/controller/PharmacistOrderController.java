...
import com.pharmacy.form.OrderStatusForm;
import com.pharmacy.model.*;
import com.pharmacy.service.AlertService;
import com.pharmacy.service.OrderItemService;
import com.pharmacy.service.PharmacyProductService;
import com.pharmacy.service.UserOrderService;
...
public class PharmacistOrderController {
    ...
    /*    PharmacyProduct pharmacyProduct = PharmacyProductService.findById(Integer.valueOf(pharmacyProductId));
        ...
        User user1 = userService.findUserByEmail(auth1.getName());
        Pharmacy pharmacy1 = user1.getPharmacy();

        modelAndView.addObject("pharmacyProduct", pharmacyProduct);
        modelAndView.addObject("pharmacyName", pharmacy1.getPharmacy_name());
        modelAndView.addObject("userFullName", user1.getName() +" "+ user1.getLastName());
        ...
        LOGGER.info("PharmacistProductController:editProductPage:pharmacyName:"+ pharmacy1.getPharmacy_name());
        LOGGER.info("PharmacistProductController:editProductPage:userFullName:"+ user1.getName() +" "+ user1.getLastName());
